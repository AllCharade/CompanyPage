        ...
        <>
            <div className="w-full flex flex-col border font-mono text-slate-200 p-10 mobile:p-4 bg-slate-200 mobile:rounded-t-xl rounded-t-2xl mt-[10%]">
                ...
                <div className="w-full flex items-center">
                    ...
                    <a className="desktop:w-[10rem] tablet:w-[8rem] tablet:h-[3rem] desktop:h-[4rem] desktop:text-[1.5rem] mobile:w-[6rem] mobile:h-[2rem] mobile:rounded-lg mobile:ml-[1rem] mobile:text-[1rem] font-mono ml-[2rem] duration-300 border-[#151515] mobile:hover:border-2 desktop:hover:border-4 hover:bg-[#98f144] hover:font-bold hover:text-[#151515] rounded-2xl bg-[#151515] flex justify-center items-center" href="">
                        Lets talk
                    </a>
                </div>
